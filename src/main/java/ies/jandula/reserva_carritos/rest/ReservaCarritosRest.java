...
import ies.jandula.reserva_carritos.repository.ReservasRepository;
import ies.jandula.reserva_carritos.repository.TramosHorariosRepository;
import lombok.extern.log4j.Log4j2;

@RequestMapping(value = "/bookings/previous_resources", produces = { "application/json" })
@RestController
@Log4j2
...
//			Para cualquier error inesperado, devolverá un 500
			...
			@RequestHeader(value = "nAlumnos", required = true) int nAlumnos)
	{
		try
		{
			...
			Optional<ReservaFijas> optinalReserva = this.reservasRepository.encontrarReserva(email, aulaYCarritos,
